...
<h3> New Order</h3>
    ...
    <p><img src="images/person.png" alt="icons" id="icon"></p>
    <p>
        ...
        <p>
            ...
            <input type="text" name="streetNumber" class="addy" required>
        </p>
        <p>
            <label>Street Name</label>
            <input type="text" name="streetName" class="addy" required>
        </p>
        <p>
            <label>State</label>
            <input type="text" name="state" class="addy" required>
        </p>
        <p>
            <label>Country</label>
            <input type="text" name="country" class="addy"required>
        </p>
        </fieldset>
        <fieldset>
        <p> <strong> Order Information </strong></p>   
        <p> Please Select Order Size </p>
        <input type="radio" id="size" name="ordersize" value="small">
  <label for="small">Small</label>
  <input type="radio" id="size" name="ordersize" value="medium">
  <label for="medium">Medium</label>
  <input type="radio" id="size" name="ordersize" value="large">
  <label for="large">Large</label>
        <p>
        </fieldset>
            <input type="submit" value="Place Order" id="loginnav">
        </p>
    </form>
